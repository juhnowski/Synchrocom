...
*/
package synchrocom.sctp.netstat;

/**
 * Конфигурация сети, динамическое управление узлами (назначение активного 
 * синхронизирующего узла, определение резервных синхронизирующих узлов, 
