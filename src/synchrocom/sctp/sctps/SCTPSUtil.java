...
*/
package synchrocom.sctp.sctps;

/**
 *
 * @author Ilya
 */
public class SCTPSUtil {
    public static final byte SCTPS_SoC = 1;
    public static final byte SCTPS_Req = 2;
    public static final byte SCTPS_Resp = 3;
    public static final byte SCTPS_SoA = 4;
