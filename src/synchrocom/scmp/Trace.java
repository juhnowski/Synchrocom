 ...
 */
public class Trace extends Echo{
    /**
     * Количество хопов исходящего пакета
     */
    public short HopSendCnt;
    
    /**
     * Количество хопов возвращающегося пакета
     */
    public short HopRcvCnt;
    
    /**
     * Скорость линии связи
     */
    public int SpeedLine;
    ...
    public Trace(byte Type, byte Code) {
        super(Type, Code);
    }
}
